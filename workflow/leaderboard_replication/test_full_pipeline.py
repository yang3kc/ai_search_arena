...
def test_full_pipeline():
    ...
    battles_no_ties = leaderboard_df[~leaderboard_df['winner'].isin(['tie', 'tie (bothbad)'])]
    ...
    try:
        anchor_model = battles_no_ties['model_a'].value_counts().index[0]  # Use most common model as anchor
