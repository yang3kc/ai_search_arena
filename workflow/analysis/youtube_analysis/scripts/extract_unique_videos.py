...
def extract_unique_videos(youtube_citations):
    ...
    unique_videos = youtube_citations.groupby('video_id').agg({
    ...
    unique_videos.columns = [
        'video_id', 'citation_count', 'unique_response_count', 'sample_url',
        'min_citation_number', 'max_citation_number', 
        'min_citation_order', 'max_citation_order'
    ]
